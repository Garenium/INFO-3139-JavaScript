  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Card className="card">
        ...
        <CardContent style={{color: messageColor, fontSize: 20}}>The Message is:</CardContent>
        ...
        />
        <Button onClick={handleAddWord} disabled={isSubmitDisabled} variant="contained" color="primary">
          Add Word
        </Button>
